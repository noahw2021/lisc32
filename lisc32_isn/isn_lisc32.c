...
void IsniLoadLisc32(void* Ctx) {
    ...
    IsnLoadData(Ctx, "__POP 43-16 (R:04,08=__DEST) : Pops from the stack into a register");
    IsnLoadData(Ctx, "PUSHI 44-40 (I:32,32=SOURCE) : Pushes an immediate to the stack");
    return;
}
